...
Public Class CRpemesananHeader
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PembelianObat.CRpemesananHeader.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRpemesananHeader
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRpemesananHeader = New CRpemesananHeader()
        rpt.Site = Me.Site
        Return rpt
    End Function
