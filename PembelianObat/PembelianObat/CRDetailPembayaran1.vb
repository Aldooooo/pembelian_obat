...
Public Class CRDetailPembayaran
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PembelianObat.CRDetailPembayaran.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRDetailPembayaran
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRDetailPembayaran = New CRDetailPembayaran()
        rpt.Site = Me.Site
        Return rpt
    End Function
