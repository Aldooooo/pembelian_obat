...
Public Class CRpembayaranHeader
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PembelianObat.CRpembayaranHeader.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRpembayaranHeader
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRpembayaranHeader = New CRpembayaranHeader()
        rpt.Site = Me.Site
        Return rpt
    End Function
