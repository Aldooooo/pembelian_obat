...
Public Class CRdistributor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PembelianObat.CRdistributor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRdistributor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRdistributor = New CRdistributor()
        rpt.Site = Me.Site
        Return rpt
    End Function
