...
Public Class CRDetailPemesanan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PembelianObat.CRDetailPemesanan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRDetailPemesanan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRDetailPemesanan = New CRDetailPemesanan()
        rpt.Site = Me.Site
        Return rpt
    End Function
